...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{images/ble_architecture.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{images/chip_count.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{images/advertising_scanning.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{images/connection_event.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{images/gatt_server.png}
	\caption{GATT server}
\end{figure}
